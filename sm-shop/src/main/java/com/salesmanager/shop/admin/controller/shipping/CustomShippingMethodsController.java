...
import com.salesmanager.shop.utils.ProductPriceUtils;
import com.salesmanager.shop.utils.AjaxPageableResponse;
import com.salesmanager.shop.utils.AjaxResponse;
...
public class CustomShippingMethodsController {
	...
	public String saveShippingMethod(@ModelAttribute("configuration") CustomShippingQuotesConfiguration configuration, BindingResult result, Model model, HttpServletRequest request, HttpServletResponse response, Locale locale) throws Exception {
		...
		environments.add(com.salesmanager.shop.constants.Constants.TEST_ENVIRONMENT);
		environments.add(com.salesmanager.shop.constants.Constants.PRODUCTION_ENVIRONMENT);
...
/*		List<Country> shippingCountries = new ArrayList<Country>();
		...
		List<String> environments = new ArrayList<String>();
		environments.add(com.salesmanager.shop.constants.Constants.PRODUCTION_ENVIRONMENT);//only production
