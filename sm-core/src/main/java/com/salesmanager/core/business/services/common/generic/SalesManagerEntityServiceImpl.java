...
public abstract class SalesManagerEntityServiceImpl<K extends Serializable & Comparable<K>, E extends SalesManagerEntity<K, ?>>
	...
	public void save(@InOut E entity) throws ServiceException {
		repository.saveAndFlush(entity);
	}
	
	
	public void create(@InOut E entity) throws ServiceException {
		save(entity);
	}

	
	
	public void update(@InOut E entity) throws ServiceException {
		save(entity);
	}
