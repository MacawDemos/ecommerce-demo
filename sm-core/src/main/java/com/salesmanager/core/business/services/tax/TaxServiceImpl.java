...
public class TaxServiceImpl 
	...
	@Override
	public void saveTaxConfiguration( @com.salesmanager.core.business.services.common.generic.InOut TaxConfiguration shippingConfiguration, MerchantStore store) throws ServiceException {
