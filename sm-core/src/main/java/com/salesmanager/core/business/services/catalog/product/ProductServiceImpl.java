...
public class ProductServiceImpl extends SalesManagerEntityServiceImpl<Long, Product> implements ProductService {
	...
	@Override
	public void addProductDescription( @com.salesmanager.core.business.services.common.generic.InOut Product product, ProductDescription description)
	...
	@Override
	public void create( @com.salesmanager.core.business.services.common.generic.InOut Product product) throws ServiceException {
		this.saveOrUpdate(product);
		searchService.index(product.getMerchantStore(), product);
	}
	
	@Override
	public void update( @com.salesmanager.core.business.services.common.generic.InOut Product product) throws ServiceException {
		this.saveOrUpdate(product);
		searchService.index(product.getMerchantStore(), product);
	}
	

	private void saveOrUpdate( @com.salesmanager.core.business.services.common.generic.InOut Product product) throws ServiceException {
