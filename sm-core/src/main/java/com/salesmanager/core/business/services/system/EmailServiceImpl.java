...
public class EmailServiceImpl implements EmailService {
	...
	@Override
	public void saveEmailConfiguration( @com.salesmanager.core.business.services.common.generic.InOut EmailConfig emailConfig, MerchantStore store) throws ServiceException {
		MerchantConfiguration configuration = merchantConfigurationService.getMerchantConfiguration(Constants.EMAIL_CONFIG, store);
		if(configuration==null) {
