...
public class OrderServiceImpl  extends SalesManagerEntityServiceImpl<Long, Order> implements OrderService {
    ...
    @Override
    public void addOrderStatusHistory( @com.salesmanager.core.business.services.common.generic.InOut Order order, OrderStatusHistory history) throws ServiceException {
...
/*    @Override
    ...
    @Override
    public void saveOrUpdate( @com.salesmanager.core.business.services.common.generic.InOut final Order order) throws ServiceException {
