...
public class CategoryServiceImpl extends SalesManagerEntityServiceImpl<Long, Category> implements CategoryService {
	...
	public void create( @com.salesmanager.core.business.services.common.generic.InOut Category category) throws ServiceException {
	...
	@Override
	public void saveOrUpdate( @com.salesmanager.core.business.services.common.generic.InOut Category category) throws ServiceException {
